...
export const EverythingSection: React.FC = () => (
  <section className="home-everything-section" style={{ background: '#FEF3DC', padding: '80px 80px', overflow: 'hidden' }}>
    <div className="home-everything-row" style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', gap: 50, alignItems: 'stretch' }}>
      {/* Left card */}
      <div className="home-everything-left interactive-lift" style={{ flex: '0 0 630px', background: '#fff', borderRadius: 32, padding: '40px 40px 48px', display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {/* Right card — image */}
      <div className="home-everything-right home-card" style={{ flex: 1, borderRadius: 32, overflow: 'hidden', height: 680 }}>
        <ScrollReveal variant="right" className="home-card-media" style={{ height: '100%' }}>
          <img
