...
export const HeroSection: React.FC<HeroSectionProps> = ({ onJoinClick }) => (
  <section style={{ position: 'relative', width: '100%', height: 850, overflow: 'hidden' }}>
    ...
    {/* Content */}
    <div style={{ position: 'relative', zIndex: 10, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '120px 80px 60px' }}>
      {/* Pill */}
      ...
      {/* Heading */}
      <h1 style={{ fontFamily: SF, fontSize: 72, fontWeight: 700, color: '#fff', lineHeight: 1.1, maxWidth: 760, marginBottom: 24 }}>
        Your Roadmap to a Profitable Dental Practice
      </h1>

      {/* Subtext */}
      <p style={{ fontFamily: SF, fontSize: 18, fontWeight: 400, color: 'rgba(255,255,255,0.85)', maxWidth: 560, lineHeight: 1.55, marginBottom: 36 }}>
