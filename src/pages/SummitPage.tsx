...
const SolutionCard = () => (
  <div className="interactive-lift summit-solution-card page-load-reveal page-load-reveal--delay-2" style={{ background: '#fff', borderRadius: 16, padding: '28px 24px', display: 'flex', flexDirection: 'column', gap: 12 }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      <svg width={20} height={20} viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="9" stroke={GOLD} strokeWidth={1.5}/><path d="M6 10l3 3 5-5" stroke={GOLD} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/></svg>
      <p className="page-load-reveal page-load-reveal--delay-4" style={{ fontFamily: SF, fontSize: 15, fontWeight: 600, color: DARK, margin: 0 }}>You have a marketing problem.</p>
    </div>
    <p className="page-load-reveal page-load-reveal--delay-4" style={{ fontFamily: SF, fontSize: 15, fontWeight: 700, color: GOLD, margin: '8px 0 0', lineHeight: 1.4 }}>And this summit is the solution.</p>
  </div>
);

/* ── Video card — YouTube embed (portrait) ── */
const VideoCard = ({ videoId }: { videoId: string }) => (
  <div className="interactive-lift summit-video-card page-load-reveal page-load-reveal--delay-1" style={{ flexShrink: 0, width: 400, height: 700, borderRadius: 20, overflow: 'hidden', background: '#000' }}>
    <iframe
...
const SpeakerCard = ({ name, designation, photo }: { name: string; designation: string; photo: string }) => (
  <div className="interactive-lift summit-speaker-card page-load-reveal page-load-reveal--delay-1" style={{ flexShrink: 0, width: 400, borderRadius: 20, overflow: 'hidden', background: '#3a3a3a' }}>
    ...
    <div style={{ padding: '18px 28px 24px' }}>
      <p className="page-load-reveal page-load-reveal--delay-2" style={{ fontFamily: SF, fontSize: 24, fontWeight: 700, color: '#fff', margin: '0 0 4px' }}>{name}</p>
      <p className="page-load-reveal page-load-reveal--delay-3" style={{ fontFamily: SF, fontSize: 16, color: 'rgba(255,255,255,0.6)', margin: 0 }}>{designation}</p>
    </div>
  </div>
);
...
const NavArrow = ({ dir, onClick, bg = DARK, invertIcon = false }: { dir: 'left' | 'right'; onClick?: () => void; bg?: string; invertIcon?: boolean }) => (
  <button onClick={onClick} className="interactive-button" style={{ width: 44, height: 44, borderRadius: '50%', border: 'none', background: bg, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0, padding: 0 }}>
    <img
...
export const SummitPage: React.FC = () => {
  ...
  return (
    <div style={{ background: CREAM }}>
      {/* ── Hero ── */}
      <section className="summit-hero" style={{ position: 'relative', width: '100%', height: 850, overflow: 'hidden' }}>
      ...
      <section className="summit-page-section summit-problem-section" style={{ background: DARK, padding: '80px 0' }}>
        <div style={{ maxWidth: 1440, margin: '0 auto', padding: '0 80px' }}>
          <ScrollReveal>
            ...
            <p className="section-text-reveal page-load-reveal--delay-1" style={{ fontFamily: SF, fontSize: 16, color: 'rgba(255,255,255,0.7)', lineHeight: 1.65, marginBottom: 48, maxWidth: 500 }}>
          ...
          <ScrollReveal>
            <div className="summit-section-header summit-videos-header" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 40 }}>
              <div className="summit-section-copy">
                ...
                <p className="section-text-reveal page-load-reveal--delay-1" style={{ fontFamily: SF, fontSize: 16, color: DARK, lineHeight: 1.65, margin: 0, maxWidth: 460 }}>
      ...
      <section className="summit-page-section summit-about-section" style={{ background: '#F4EEE5', padding: '80px 0' }}>
        <div style={{ maxWidth: 1440, margin: '0 auto', padding: '0 80px' }}>
          <ScrollReveal>
            ...
            <p className="section-text-reveal page-load-reveal--delay-1" style={{ fontFamily: SF, fontSize: 16, color: DARK, lineHeight: 1.65, margin: '0 0 40px', maxWidth: 700 }}>
          ...
          <ScrollReveal variant="scale">
            <div className="summit-conference-card" style={{ borderRadius: 40, border: '1px solid #ECD465', overflow: 'hidden', display: 'flex', position: 'relative', background: DARK, minHeight: 660 }}>
              ...
              <div className="summit-conference-left" style={{ flex: '0 0 50%', padding: '60px 80px 60px 60px', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 28 }}>
                ...
                <h2 className="section-text-reveal" style={{ fontFamily: SF, fontSize: 55, fontWeight: 700, color: '#fff', lineHeight: 1.2, margin: 0 }}>
                  <span className="page-load-reveal page-load-reveal--delay-1">This Isn't Another</span>{' '}
                  <span className="page-load-reveal page-load-reveal--delay-2" style={{ color: '#ECD465' }}>Dental Conference.</span>
                  <br />
                  <span className="page-load-reveal page-load-reveal--delay-2">Most events give you</span>{' '}
                  <span className="page-load-reveal page-load-reveal--delay-3" style={{ color: '#ECD465' }}>inspiration.</span>
                  <br />
                  <span className="page-load-reveal page-load-reveal--delay-3">This one gives you</span>{' '}
                  <span className="page-load-reveal page-load-reveal--delay-4" style={{ color: '#ECD465' }}>implementation.</span>
                </h2>
              </div>
              ...
              <div className="summit-conference-right page-load-reveal page-load-reveal--delay-2" style={{ flex: 1, background: '#FFD073', borderRadius: 28, margin: 12, padding: '40px 40px 40px 60px', display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                {[
                  ...
                  <div key={item} className={"page-load-reveal page-load-reveal--delay-" + Math.min((index % 4) + 1, 4)} style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#fff', border: '1px solid #E3AA33', borderRadius: 8, padding: 10 }}>
                    <img src="/summit-check-icon.svg" alt="" className="interactive-lift summit-check-icon" style={{ width: 24, height: 24, flexShrink: 0 }} />
                    <p className="page-load-reveal page-load-reveal--delay-4" style={{ fontFamily: SF, fontSize: 16, color: DARK, lineHeight: 1.5, margin: 0 }}>{item}</p>
                  </div>
                ))}
              </div>
            </div>
