    ...
    <div style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', gap: 50, alignItems: 'flex-start' }}>
      ...
      <div style={{ flex: '0 0 580px' }}>
        <ScrollReveal variant="left">
          ...
          <h2 style={{ fontFamily: SF, fontSize: 56, fontWeight: 700, lineHeight: 1.1, marginBottom: 20 }}>
            <span style={{ color: '#131313' }}>Three practices.</span><br />
            <span style={{ color: '#C58F28' }}>One proven system.</span>
          </h2>
            ...
            {PRACTICES.map((p, i) => (
              <div key={p.num}>
                <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start', padding: '24px 0' }}>
                  <span style={{ fontFamily: SF, fontSize: 48, fontWeight: 700, color: '#C58F28', lineHeight: 1, minWidth: 70 }}>{p.num}</span>
                  <div style={{ width: 1, background: '#C58F28', alignSelf: 'stretch', margin: '4px 0', opacity: 0.4 }} />
                  <div style={{ flex: 1 }}>
      ...
      {/* Right — card */}
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', borderRadius: 24, overflow: 'hidden', border: '1px solid rgba(0,0,0,0.1)' }}>
        <ScrollReveal variant="right" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          {/* Image */}
          <div style={{ height: 358, position: 'relative', background: '#ccc' }}>
            <img src="/practices-clinic.png" alt="Dentozen dental clinic" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
          </div>
          {/* Text + stats */}
          <div style={{ padding: '32px 36px', flex: 1 }}>
            <p style={{ fontFamily: SF, fontSize: 14, color: '#555', lineHeight: 1.65, marginBottom: 28 }}>
            ...
            <div style={{ display: 'flex', gap: 40 }}>
              <div>
                <p style={{ fontFamily: SF, fontSize: 12, color: '#999', marginBottom: 4 }}>First‑year revenue</p>
                <p style={{ fontFamily: SF, fontSize: 40, fontWeight: 700, color: '#131313' }}>£689k+</p>
              </div>
              <div>
                <p style={{ fontFamily: SF, fontSize: 12, color: '#999', marginBottom: 4 }}>First‑year revenue</p>
                <p style={{ fontFamily: SF, fontSize: 40, fontWeight: 700, color: '#131313' }}>90 days</p>
              </div>
            </div>
          </div>
        </ScrollReveal>
