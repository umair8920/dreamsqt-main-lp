...
export const Footer: React.FC = () => {
  ...
  return (
    <footer style={{ position: 'relative', background: '#FFFFFF', overflow: 'hidden', padding: '91px 20px 250px', minHeight: 870 }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, maxWidth: 1280, margin: '0 auto', display: 'flex', gap: 18 }}>
        ...
        <div style={{ flex: 1, minWidth: 0, borderRadius: 40, background: '#fff0d1', padding: '40px 48px 32px', position: 'relative', overflow: 'visible', minHeight: 528 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%', position: 'relative' }}>
            <div style={{ display: 'flex', gap: 0, flex: 1 }}>
              ...
              {/* Newsletter */}
              <div style={{ position: 'absolute', left: 324, top: 274, width: 329 }}>
                <h4 style={{ fontFamily: SF, fontSize: 16, fontWeight: 700, color: '#131313', marginBottom: 8, lineHeight: 1.2, maxWidth: 299 }}>
                  Join our newsletter to get regular updates
                </h4>
                <p style={{ fontFamily: SF, fontSize: 14, color: '#131313', marginBottom: 16, lineHeight: 1.3 }}>
                ...
                {subscribed ? (
                  ...
                  <form onSubmit={handleSubscribe} style={{ display: 'flex', alignItems: 'center', gap: 8, width: 329, background: '#fff', border: '1px solid #fff', borderRadius: 12, padding: '6px 6px 6px 20px' }}>
                    <input
                      type="email"
                      required
                      value={email}
